...
Enter employee data
● Print this menu of 5 choices
● Validate the input
○ It should be int from 1 to 5
○ Keep asking tell user enter valid choice
● Employee information
○ Name (including spaces)
○ Age and Salary: integers
Let’s enter more data
Print the employees
● Option 2: Print the employees
● If No employees print: No employees at the moment!
Delete by age
● Option 3
● The user enter start and end
● All employees within this age will
be deleted
Update a salary
● Option 4: Given a name and
salary, find and update the
salary of a given person
● Option 5: exit
Design
